...
void Pid_parameter_init(void){
	...
	Pid_increment_struct_init(&motor_pid_g[1].loc,  0.364706f,	0.007333f,	0.004745f,   50,    -50);
...
//	Pid_increment_struct_init(&motor_pid_g[3].loc,  0.364706f,	0.007333f,	0.004745f,   50,    -50);
//	Pid_increment_struct_init(&motor_pid_g[3].spd,  16.7f,	0.98f,	0.024314f,  12000,  -12000);
	...
	Pid_increment_struct_init(&motor_pid_g[5].loc, 0.364706f,	0.007333f,	0.004745f,   50,    -50);
	...
	Pid_increment_struct_init(&motor_pid_g[7].loc,  0.15, 	0.001,	0.03,  50,    -50);
